...
const playerRock = document.querySelector("#playerRock"),
  ...
  playerLizard = document.querySelector("#playerLizard"),
  playerSpock = document.querySelector("#playerSpock");
...
const computerRock = document.querySelector("#computerRock"),
  ...
  computerLizard = document.querySelector("#computerLizard"),
  computerSpock = document.querySelector("#computerSpock");
